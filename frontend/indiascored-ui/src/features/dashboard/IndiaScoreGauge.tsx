...
interface IndiaScoreProps {
  score: number;
  userName: string;
}

export function IndiaScore({ score, userName }: IndiaScoreProps) {
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-sm font-medium text-primary-foreground/80">IndiaScore</span>
            </div>
