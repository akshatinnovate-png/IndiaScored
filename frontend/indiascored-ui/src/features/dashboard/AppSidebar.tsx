      ...
      <SidebarContent className="bg-card">
        ...
        <div className="p-4 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            {!isCollapsed && (
              <div>
                <h2 className="font-bold text-lg text-foreground">IndiaScore</h2>
                <p className="text-xs text-muted-foreground">{isAdmin ? 'Admin Portal' : 'IndiaScored'}</p>
              </div>
            )}
          </div>
        </div>
        ...
        {!isCollapsed && (
          <div className="mt-auto p-4 border-t border-border">
            <div className="text-xs text-muted-foreground text-center">
              ...
              <p>{isAdmin ? 'IndiaScored' : 'across urban & rural India'}</p>
            </div>
          </div>
        )}
      </SidebarContent>
