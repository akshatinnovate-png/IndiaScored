...
import { IndiaScore } from "@/features/dashboard/IndiaScoreGauge";
import { LoanCard } from "@/features/dashboard/LoanCard";
import { LoanApplicationForm } from "@/features/applications/LoanApplicationForm";
import { ScoreGenerator } from "@/features/dashboard/ScoreGenerator";
        ...
        <div className="min-h-screen w-full flex bg-background">
          ...
          <header className="h-16 border-b border-border bg-card flex items-center px-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-semibold text-foreground">IndiaScore Platform</h1>
            </div>
            <Button 
              variant="outline" 
      ...
      <div className="min-h-screen w-full flex bg-background">
        ...
        <main className="flex-1">
          <header className="h-16 border-b border-border bg-card flex items-center px-6">
            ...
            <div className="flex items-center gap-2">
              <Award className="h-5 w-5 text-primary" />
              <h1 className="text-xl font-semibold text-foreground">IndiaScore Dashboard</h1>
            </div>
            <Button 
              variant="outline" 
              onClick={() => window.open('/admin', '_blank')}
          ...
          <div className="p-6 space-y-6">
            <Tabs defaultValue="dashboard" className="w-full">
              ...
              <TabsContent value="dashboard" className="space-y-6">
                {/* Welcome Section */}
                <IndiaScore score={720} userName="Rahul Sharma" />
