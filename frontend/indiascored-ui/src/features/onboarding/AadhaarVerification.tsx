...
interface AadhaarVerificationProps {
  /**
   * Called once an Aadhaar number has been read off the card. Optional, so the
   * step works both embedded in the profile form and as a standalone route.
   */
  onAadhaarExtracted?: (aadhaar: string, extractedData?: ExtractedData) => void;
}
